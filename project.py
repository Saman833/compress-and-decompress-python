...
def read_files_for_compressing():
    initial_Fname=input("write the name/location of the file you want to compress:\n")
    compressed_Fname=input("write the name/location of the file you want to be as the compressed file:\n")
    compress(initial_Fname,compressed_Fname)
def read_files_for_decompressing ():
    compressed_Fname=input("write the name/location of the file you want to decompress it :\n")
    decompressed_Fname=input("write the name/location of the file you want to be as the decompressed file:\n")
